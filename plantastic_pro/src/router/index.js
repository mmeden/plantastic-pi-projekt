...
const router = createRouter({
  ...
  routes: [
    ...
    { 
      ...
      meta: { zahtijevaPrijavu: true, samKorisnik: true } 
    },
    { 
      path: '/evidencija', 
      component: () => import('@/views/EvidencijaZalijevanjaView.vue'), 
      meta: { zahtijevaPrijavu: true, samKorisnik: true } 
    },
    { 
      path: '/evidencija/:id', 
    ...
    { path: '/admin', 
      ...
      meta: { zahtijevaPrijavu: true, zahtijevaAdmin: true } 
    },
    { path: '/biljka/:id', 
      component: () => import('@/views/BiljkaView.vue'), 
      meta: { zahtijevaPrijavu: true, samKorisnik: true } 
    },
  ]
})
